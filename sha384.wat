(module
  ...
  (func $sha384_monolith (export "sha384_monolith") (param $ctx i32) (param $input i32) (param $input_end i32) (param $final i32)
    (result i32)
    ...
    (set_local $bytes_read (i64.load offset=184 (get_local $ctx)))
    (set_local $bytes_read_overflow (i64.load offset=192 (get_local $ctx)))
    ...
    (if (i64.lt_u (get_local $bytes_read) (i64.const 128))
        (then
            (i64.store offset=0  (get_local $ctx) (i64.xor (i64.const 0xcbbb9d5dc1059ed8) (i64.const 0)))
            (i64.store offset=8  (get_local $ctx) (i64.xor (i64.const 0x629a292a367cd507) (i64.const 0)))
            (i64.store offset=16 (get_local $ctx) (i64.xor (i64.const 0x9159015a3070dd17) (i64.const 0)))   
            (i64.store offset=24 (get_local $ctx) (i64.xor (i64.const 0x152fecd8f70e5939) (i64.const 0)))
            (i64.store offset=32 (get_local $ctx) (i64.xor (i64.const 0x67332667ffc00b31) (i64.const 0)))
            (i64.store offset=40 (get_local $ctx) (i64.xor (i64.const 0x8eb44a8768581511) (i64.const 0)))
            (i64.store offset=48 (get_local $ctx) (i64.xor (i64.const 0xdb0c2e0d64f98fa7) (i64.const 0)))
            (i64.store offset=56 (get_local $ctx) (i64.xor (i64.const 0x47b5481dbefa4fa4) (i64.const 0)))))
        ...
        (loop $start
            (if (i32.eq (get_local $block_position) (i32.const 128))
                (then
                    ...
                    (set_local $bytes_read (i64.add (get_local $bytes_read) (i64.const 128)))
                    (if (i64.lt_u (get_local $bytes_read) (i64.const 128))
                        (then
                    ...
                    (set_local $b (i64.load offset=8 (get_local $ctx)))
                    (set_local $c (i64.load offset=16 (get_local $ctx)))
                    (set_local $d (i64.load offset=24 (get_local $ctx)))
                    (set_local $e (i64.load offset=32 (get_local $ctx)))
                    (set_local $f (i64.load offset=40 (get_local $ctx)))
                    (set_local $g (i64.load offset=48 (get_local $ctx)))
                    (set_local $h (i64.load offset=56 (get_local $ctx)))
            ...
            (br_if $end (i32.ge_u (get_local $ptr) (get_local $end_point)))
